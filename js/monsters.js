...
var levelState = {
    ...
    preload: function () {
		...
		game.load.image('superComboRay',"assets/super-combo-rays.png", 522, 604);
        game.load.image('superComboBack',"assets/super-combo-back.png",504,367);
        game.load.image('superComboText',"assets/super-combo.png",387,144);
		...
		game.load.image('ultraComboRay',"assets/ultra-combo-rays.png", 522, 604);
        game.load.image('ultraComboBack',"assets/ultra-combo-back.png",504,367);
        game.load.image('ultraComboText',"assets/ultra-combo.png",387,144);
