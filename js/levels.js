var levelsConfig = [
    {
        ...
        path : [
            ...
            {x:1,y:0,allowTarget: true},
            {x:2,y:0,allowTarget: true},
            {x:3,y:0,allowTarget: true},
            {x:4,y:0,allowTarget: true},
            {x:4,y:1,allowTarget: true},
            {x:4,y:2,allowTarget: true},
            ...
            {x:3,y:5,allowTarget: true},
            {x:2,y:5,allowTarget: true},
            {x:1,y:5,allowTarget: true},
            {x:0,y:5,allowTarget: true},
